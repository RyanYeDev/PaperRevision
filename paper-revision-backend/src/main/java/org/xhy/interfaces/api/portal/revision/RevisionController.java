package org.xhy.interfaces.api.portal.revision;
...
import org.xhy.domain.revision.service.RevisionExecutor;
import org.xhy.domain.revision.service.TextDiffEngine;
import org.xhy.domain.evaluation.service.RevisionEvaluator;
import org.xhy.domain.tool.service.ToolRegistry;
import org.xhy.domain.tool.service.SkillRegistry;
import org.xhy.domain.workflow.service.WorkflowEngine;
import org.xhy.domain.trace.service.ExecutionTraceDomainService;
...
public class RevisionController {
    ...
    public RevisionController(RevisionExecutor revisionExecutor, PaperDomainService paperDomainService,
            ...
            RevisionEvaluator revisionEvaluator, WorkflowEngine workflowEngine,
    ...
    public Result<Map<String, Object>> executeRevision(@RequestBody Map<String, Object> request) {
        ...
        traceService.recordStep(traceId, "START", "revision_execution", "开始返修", "");
        ...
        traceService.recordStep(traceId, "END", "revision_complete", "返修完成", evaluation.toString());
